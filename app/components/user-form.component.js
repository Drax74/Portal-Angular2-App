System.register(['angular2/core', 'angular2/common', '../basicValidator', 'angular2/router', '../services/user.service', '../user'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, common_1, basicValidator_1, router_1, user_service_1, user_1;
        ...
        execute: function() {
            UserFormComponent = (function () {
                ...
                UserFormComponent = __decorate([
                    core_1.Component({
                        templateUrl: 'app/templates/user-form.template.html',
